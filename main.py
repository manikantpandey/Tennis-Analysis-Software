...
def main():
    ...
    output_video_frame = mini_court.draw_points_on_mini_court(output_video_frame,player_mini_court_detections)
    output_video_frame = mini_court.draw_points_on_mini_court(output_video_frame,ball_mini_court_detections, color=(0,255,255))
